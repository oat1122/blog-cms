...
> หมายเหตุ: ทั้ง 8 ตัวนี้คือสิ่งที่ต้องใช้ ห้ามสลับเป็นตัวอื่น (เพราะเป็นโจทย์ฝึกเฉพาะ stack นี้) ส่วน database engine เลือก PostgreSQL เป็นค่าเริ่มต้น (Drizzle รองรับ MySQL/SQLite ด้วยถ้าอยากลอง)
